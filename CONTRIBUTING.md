...
* In Github, fork `https://github.com/hooklift/oauth2` to your own account
* Get the package using "go get": `go get github.com/hooklift/oauth2`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/hooklift/oauth2`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/oauth2.git`
