...
func authCodeGrant2(w http.ResponseWriter, req *http.Request, cfg *config) {
}

// Implements http://tools.ietf.org/html/rfc6749#section-4.3
func resourceOwnerCredentialsGrant(w http.ResponseWriter, req *http.Request, cfg *config) {
}

// Implements http://tools.ietf.org/html/rfc6749#section-4.4
func clientCredentialsGrant(w http.ResponseWriter, req *http.Request, cfg *config) {
}

// Implements http://tools.ietf.org/html/rfc6749#section-5
func IssueAccessToken(w http.ResponseWriter, req *http.Request, cfg *config) {
}

// Implements http://tools.ietf.org/html/rfc6749#section-6
func refreshToken(w http.ResponseWriter, req *http.Request, cfg *config) {
